...
"   "c,elixir,elm,erlang,go,haskell,html,javascript,lisp,lua,ocaml,perl,php,python,ruby,rust,scala"
  ...
  silent !\curl -fLo ~/.vim/autoload/plug.vim --create-dirs https://raw.githubusercontent.com/junegunn/vim-plug/master/plug.vim
	...
	if v:version >= 704
	    ...
	    if filereadable(expand("~/.vimrc.local.bundles"))
	      ...
	      " Search mappings: These will make it so that going to the next
	      " one in a
	      ...
	      "                "" Autocmd Rules
	      "*****************************************************************************
	      """ The PC is fast enough, do syntax highlight syncing from
	      start unless 200 lines
		  ...
		  augroup vimrc-remember-cursor-position
			  ...
			  augroup vimrc-make-cmake
				...
				"
				" "" Opens an edit command with the path of
				" the currently edited file filled in
				" noremap <Leader>e :e <C-R>=expand("%:p:h") .
				" "/" <CR>
				"
				" "" Opens a tab edit command with the path of
				" the currently edited file filled
			  ...
			  "       "always" '.shellescape(<q-args>).'| tr -d
			  "       "\017"', 1, <bang>0)
			  "       endif
			  "
			  "       cnoremap <C-P> <C-R>=expand("%:p:h") . "/"
			  "       <CR>
			  ...
			  if has('unnamedplus')
			    ...
			    if has('macunix')
				      ...
				      "" Vmap for maintain Visual Mode after
				      shifting > and <
				      vmap < <gv
				      vmap > >gv
				      ...
				      " " go
				      " " vim-go
				      " " run :GoBuild or :GoTestCompile based
				      " on the go file
				      ...
				      "                 BufNewFile,BufRead
				      "                 *.go setlocal
				      "                 noexpandtab tabstop=4
				      "                 shiftwidth=4
				      "                 softtabstop=4
				      "
				      "                 augroup
				      "                 completion_preview_close
				      "                   autocmd!
				      "                     if v:version > 703
				      "                     || v:version ==
				      "                     703 &&
				      ...
				      "                                                                                   vim-airline
				      "                                                                                   let
				      "                                                                                   g:airline#extensions#virtualenv#enabled
				      "                                                                                   =
				      "                                                                                   1
				      "
				      "                                                                                   "
				      ...
				      "                                                                                                                                                     vnoremap
				      "                                                                                                                                                     <leader>relv
				      "                                                                                                                                                     :RExtractLocalVariable<cr>
				      "                                                                                                                                                     nnoremap
				      "                                                                                                                                                     <leader>rit
				      "                                                                                                                                                     :RInlineTemp<cr>
				      "                                                                                                                                                     vnoremap
				      "                                                                                                                                                     <leader>rrlv
				      "                                                                                                                                                     :RRenameLocalVariable<cr>
				      "                                                                                                                                                     vnoremap
				      "                                                                                                                                                     <leader>rriv
				      "                                                                                                                                                     :RRenameInstanceVariable<cr>
				      "                                                                                                                                                     vnoremap
				      "                                                                                                                                                     <leader>rem
				      "                                                                                                                                                     :RExtractMethod<cr>
				      "
